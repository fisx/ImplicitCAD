...
import Criterion.Main (Benchmark, bench, bgroup, defaultMain, nf, nfAppIO)
-- The parts of ImplicitCAD we know how to benchmark.
import Graphics.Implicit (ExtrudeMScale (C1), SymbolicObj2, SymbolicObj3, circle, difference, extrudeM, rect3, sphere, translate, union, unionR, withRounding, writeBinSTL, writeDXF2, writePNG2, writeSTL, writeSVG)
-- The variables defining distance and counting in our world.
import Graphics.Implicit.Definitions (Fastℕ, defaultObjectContext, ℝ)
...
import Prelude (Either (Left, Right), IO, String, cos, fmap, fromIntegral, pi, pure, zip3, ($), (*), (/), (<$>), (<>))
