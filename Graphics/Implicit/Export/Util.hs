...
import Graphics.Implicit.Definitions (NormedTriangle (NormedTriangle), Obj3, Triangle (Triangle), ℝ, ℝ3)
import Linear (V3 (V3), normalize, (*^), (^/))
import Prelude (Applicative, Foldable, Fractional, Num, length, pure, realToFrac, (+), (-), (/))
