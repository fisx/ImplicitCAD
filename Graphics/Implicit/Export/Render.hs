...
import Graphics.Implicit.Definitions (Fastℕ, Obj2, Obj3, Polyline (Polyline), SymbolicObj2, SymbolicObj3, TriangleMesh, fromℕ, fromℕtoℝ, ℕ, ℝ, ℝ2, ℝ3, (⋯/))
...
import Prelude (Int, ceiling, div, error, fmap, foldMap, max, min, reverse, tail, ($), (*), (+), (-), (.), (<$>), (<>))
