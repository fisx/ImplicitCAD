...
import Graphics.Implicit.IntegralUtil as N (fromℕ, toℕ, ℕ)
...
import Prelude (Bool (False, True), Double, Either (Left, Right), Eq, Float, Monoid (mempty), Ord, RealFloat, Semigroup ((<>)), abs, asin, atan2, flip, fromIntegral, pi, realToFrac, signum, ($), (*), (+), (-), (/), (==), (>=))
